...
- Next gate: approval-record write gate design only; approval record writes, dry-run invocation, and real install/update/rollback execution remain blocked.
