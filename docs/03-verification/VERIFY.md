...
- Next gate: user-visible approval/preview flow refinement in Control Center only; approval record writes, dry-run invocation, and real install/update/rollback execution remain blocked.
