...
- Gateway routes: `GET /approval/execution-proposal`, `GET /approval/execution-proposal/verify`, `GET /approval/audit-write-design`, and `GET /approval/audit-write-design/verify`
- Control Center integration: `control snapshot`, `control summary`, and `control html` must expose the `Execution Approval` panel with proposal, authority legend, approval packet validation, planned audit items, audit write design, blocked actions, and next safe action.
- Work surface integration: `control work-surface`, `control work-surface-html`, and `control work-surface-check` must expose execution proposal confirmation and planned audit items after the local draft preview and before any execution action.
...
- Visual QA evidence: `docs/03-verification/evidence/execution-approval-ux-qa-2026-07-09.json`, `docs/03-verification/evidence/EXECUTION-APPROVAL-UX-QA-2026-07-09.md`, `docs/03-verification/evidence/audit-write-design-qa-2026-07-09.json`, and `docs/03-verification/evidence/AUDIT-WRITE-DESIGN-QA-2026-07-09.md`.
