...
- Next gate: one more read-only approval/preview interaction drilldown or packaged desktop planning may proceed, but approval record writes, dry-run invocation, and real install/update/rollback execution remain blocked.
