...
- Next gate: pure approval-packet validation design/implementation only; approval record writes, dry-run invocation, and real install/update/rollback execution remain blocked.
