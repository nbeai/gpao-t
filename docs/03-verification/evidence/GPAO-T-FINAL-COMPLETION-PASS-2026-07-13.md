...
- 현재까지 닫힌 증거:
  ...
  - Test-team archive: `/Users/jyp/Documents/Playground 2/gpao-t/.gpao-t/releases/gpao-t-0.1.0-test-team.1.zip`
  - Test-team archive SHA-256: `f3ba7c545c1d0fd4e64260253b47af0a388b5fee00f069f757ba7255e1313ad7`
...
- 종료점: 테스트팀이 설치, 실행, 검증할 수 있는 배포 직전 버전과 동일한 산출물이 실제 사용자 PC에서 독립 GPAO-T로 정상 라이브되는 상태.
...
| 8. 전체 테스트/소스/테스트팀 패킷 봉인 | IN_PROGRESS | 전체 테스트, 패키지 검증, 라이브 재설치, live health, 대화 QA 재검증, 테스트 세션 cleanup 완료. 문서/release packet 반영과 diff check 남음. |

## Stage 3 증거

- Archive: `/Users/jyp/Documents/Playground 2/gpao-t/.gpao-t/releases/gpao-t-0.1.0-test-team.1.zip`
- SHA-256: `f3ba7c545c1d0fd4e64260253b47af0a388b5fee00f069f757ba7255e1313ad7`
- Checksum file: `/Users/jyp/Documents/Playground 2/gpao-t/.gpao-t/releases/gpao-t-0.1.0-test-team.1.zip.sha256`
- Manifest version: `0.1.0-test-team.1`
...
- Verification:
  - `node tools/verify-gpao-t-test-team-distribution.mjs --archive ...`: PASS
...
- Installed release: `/Users/jyp/.gpao-t/releases/gpao-t-0.1.0-test-team.1`
- Current pointer: `/Users/jyp/.gpao-t/current -> /Users/jyp/.gpao-t/releases/gpao-t-0.1.0-test-team.1`
...
- Verification:
  ...
  - `npm run package:test-team`: PASS
  - `zip -T .gpao-t/releases/gpao-t-0.1.0-test-team.1.zip`: PASS
  - `node tools/verify-gpao-t-test-team-distribution.mjs --archive ...`: PASS
  - live install: PASS
  - `curl -fsS http://127.0.0.1:18799/health`: `{"ok":true,"status":"live"}`
...
- Reinstall preflight:
  - Same canonical release: `/Users/jyp/Documents/Playground 2/gpao-t/.gpao-t/releases/gpao-t-0.1.0-test-team.1`
...
1. Stage 8: 최신 source seal, release evidence, 테스트팀 패킷 최종 봉인.
