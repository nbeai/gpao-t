...
- `control work-surface-check` verifies the work surface preserves draft-only input, native no-script readability details, preview-only context/skill/model routing, closed authority actions, no script, no form, and no external URL
